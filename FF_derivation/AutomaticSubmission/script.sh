...
git clone https://github.com/jandrejk/FakeFactor.git -b FF_DeepTau_${ERA}_v15_v7 .
git clone https://github.com/CMS-HTT/Jet2TauFakes.git HTTutilities/Jet2TauFakes
cd HTTutilities/Jet2TauFakes
git checkout v0.2.1
cd ../../
scram b -j 8
mkdir /ceph/jandrej/auto-puppi-fakefactors/${PASS}_${FAIL}_${ERA}_${EXT}/${CHANNEL} -p
mkdir /ceph/jandrej/auto-puppi-fakefactors/${PASS}_${FAIL}_${ERA}_${EXT}/${CHANNEL}/sim -p
mkdir /ceph/jandrej/auto-puppi-fakefactors/${PASS}_${FAIL}_${ERA}_${EXT}/${CHANNEL}/Images_EMB -p
...
sed -i 's#output_folder =.*#output_folder ="/ceph/jandrej/auto-puppi-fakefactors/'${PASS}'_'${FAIL}'_'${ERA}'_'${EXT}'/";#g' ViennaTool/Settings.h
